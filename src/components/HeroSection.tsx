        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left fade-in">
            ...
            <blockquote className="text-lg md:text-xl text-white/90 mb-8 italic">
              ...
              <span className="text-accent-light">(அறம் சமுதாயத்தை காக்கும்)</span>"
            </blockquote>
          ...
          <div className="flex justify-center lg:justify-end slide-up">
            <div className="card-elegant max-w-md w-full text-center">
              ...
              <div className="relative mb-6">
                <div className="w-32 h-32 mx-auto rounded-full overflow-hidden border-4 border-primary/30 shadow-elegant">
                  <img 
                    src={profileImage} 
                    alt="R. Nandakumar" 
